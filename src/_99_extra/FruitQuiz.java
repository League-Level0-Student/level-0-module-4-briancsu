...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which is not a real fruit? <br> A: Lion Fruit <br> B: Bannana <br> C: Pear</html>");
		question3 = new JLabel("<html>Which is not a real fruit? <br> A: Strawberry <br> B: Pineapple <br> C: Brocolli</html>");
		question4 = new JLabel("<html>Which is not a real fruit? <br> A: Blueberry <br> B: Blackberry <br> C: Redberry</html>");
	}
